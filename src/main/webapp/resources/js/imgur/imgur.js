    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p1 = this.createEls('span', {}, '');
                p2 = this.createEls('span', {}, '');
                input = this.createEls('input', {type: 'file',class:'form-control', accept: 'image/*',name: 'imagem_principal',id: 'imagem_principal'});
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: "/resources/css/loading-spin.svg"});
